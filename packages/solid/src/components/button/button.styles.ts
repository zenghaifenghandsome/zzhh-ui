...
export const zzhhIconButtonClass = "zzhh-icon-button";
...
function createSubtleCompoundVariant(config:SubtleCompoundVariantConfig):SystemStyleObject{
    return{
        ...
        "&:active":{
            backgroundColor:config.bgColotActive,
        },
    };
}
...
export const buttonStyles = css({
    ...
    transition:"color 250ms, background-colot 250ms, box-shadow 250ms",
